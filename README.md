...
CS graduate from NYU. I work at the intersection of ML research and systems engineering, with a focus on biologically-inspired locomotion from connectome data, reliability and evaluation for vision-language models, and autonomous AI agents.
...
- **[OpenKBP-Project](https://github.com/neilt93/OpenKBP-Project)** — adversarial and clinical-perturbation robustness of 3D U-Net radiotherapy dose prediction (FGSM/PGD on DVH metrics); accepted at SERA 2026 (IEEE/ACIS), co-authored with Prof. Birjoo Vaishnav (U. Maryland) and Prof. Weixian Liao (Towson)
